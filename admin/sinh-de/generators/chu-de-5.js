...
function q3(type,rng){const vals=[ri(20,60,rng),ri(20,60,rng),ri(20,60,rng),ri(20,60,rng)],mx=Math.max(...vals);if(vals.filter(v=>v===mx).length!==1)return q3(type,rng);const idx=vals.indexOf(mx);return make(3,type,`Biểu đồ đoạn thẳng cho số cây trồng được: Tháng 1: ${vals[0]}, tháng 2: ${vals[1]}, tháng 3: ${vals[2]}, tháng 4: ${vals[3]}. Tháng nào cao nhất?`,`Tháng ${idx+1}`,`Giá trị lớn nhất là ${mx}.`,['Tháng 1','Tháng 2','Tháng 3','Tháng 4'].filter(x=>x!==`Tháng ${idx+1}`),2,rng)}
