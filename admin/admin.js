...
function render(){
 ...
 <div class="permission-box"><div class="permission-title">Quyền học</div><div class="check-grid"><label class="check-item"><input data-grade="8" type="checkbox" ${checked((r.allowedGrades||[]).map(Number),8)}> Toàn bộ Toán 8</label></div><hr style="border:0;border-top:1px solid var(--line);margin:14px 0"><div class="check-grid"><label class="check-item"><input data-topic="lop8-chude1" type="checkbox" ${checked(r.allowedTopics,"lop8-chude1")}> Chủ đề 1</label><label class="check-item"><input data-topic="lop8-chude2" type="checkbox" ${checked(r.allowedTopics,"lop8-chude2")}> Chủ đề 2</label></div><p class="note" style="margin:14px 0 0">Chọn “Toàn bộ Toán 8” để tự mở mọi chủ đề hiện tại và bổ sung sau này.</p></div></div>
